...
import com.liferay.oracly.accounts.payable.data.service.PayableService;
...
/**
 * Provides the base implementation for the payable remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.oracly.accounts.payable.data.service.impl.PayableServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PayableServiceBaseImpl extends BaseServiceImpl
	implements PayableService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.oracly.accounts.payable.data.service.PayableServiceUtil} to access the payable remote service.
	 */
	 ...
	 */
	public com.liferay.oracly.accounts.payable.data.service.PayableLocalService getPayableLocalService() {
	 ...
	 */
	public void setPayableLocalService(
		com.liferay.oracly.accounts.payable.data.service.PayableLocalService payableLocalService) {
		this.payableLocalService = payableLocalService;
	}

	/**
	 * Returns the payable remote service.
	 *
	 * @return the payable remote service
	 */
	...
	/**
	 * Sets the payable remote service.
	 *
	 * @param payableService the payable remote service
	 */
	...
	public String getOSGiServiceIdentifier() {
		return PayableService.class.getName();
	}
	...
	@BeanReference(type = com.liferay.oracly.accounts.payable.data.service.PayableLocalService.class)
	protected com.liferay.oracly.accounts.payable.data.service.PayableLocalService payableLocalService;
	@BeanReference(type = PayableService.class)
